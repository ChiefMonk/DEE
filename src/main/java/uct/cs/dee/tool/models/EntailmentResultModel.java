...
/**
 * <h1> EntailmentResultModel <\h1>
 * The EntailmentResult Model.
 * 
 * @author Chipo Hamayobe (chipo@cs.uct.ac.za)
 * @version 1.0.1
 * @since 2023-07-03
 */
public class EntailmentResultModel
{
    private final boolean entailment;
    private final int ranksRemoved;
    private final MinimalRankedFormulaModel rankedFormulas;
    private final PlBeliefSet remainingFormulas;
    
    private final List<String> _rankedFormulaList;   
    
    public EntailmentResultModel(boolean entailment, int ranksRemoved, MinimalRankedFormulaModel rankedFormulas, PlBeliefSet remainingFormulas)
    {
     ...
     * @return
     */
    public MinimalRankedFormulaModel getMinimalRanking()
    {

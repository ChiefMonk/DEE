...
/**
 * <h1>MinimalRankedFormulaModel<\h1>
 * The MinimalRankedFormula Model.
 * 
 * @author Chipo Hamayobe (chipo@cs.uct.ac.za)
 * @version 1.0.1
 * @since 2023-07-03
 */
public class MinimalRankedFormulaModel 
{
    List<List<PlFormula>> finitlyRankedFormulas = new ArrayList<>();
    List<PlFormula> infinitlyRankedFormulas = new ArrayList<>();
    
    public MinimalRankedFormulaModel()
    {
        this.finitlyRankedFormulas = new ArrayList<>();
        this.infinitlyRankedFormulas = new ArrayList<>();
    }
    
    public MinimalRankedFormulaModel(List<PlFormula> classicalFormulas)
    {
        this.finitlyRankedFormulas = new ArrayList<>();
        this.infinitlyRankedFormulas = classicalFormulas;
    }
    
    public MinimalRankedFormulaModel(List<PlFormula> classicalFormulas, List<List<PlFormula>> rankedFormulas)
    {
